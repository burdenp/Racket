...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname lab2) (read-case-sensitive #t) (teachpacks ((lib "universe.ss" "teachpack" "2htdp") (lib "image.ss" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "universe.ss" "teachpack" "2htdp") (lib "image.ss" "teachpack" "2htdp")))))
(require 2htdp/image)
...
(place-image (circle 10 "solid" "black") 70 70
             (place-image (circle 10 "solid" "black") 30 70
                          (place-image (rectangle 80 40 "solid" "red") 50 50
                                       (empty-scene 100 100))))
;;very little they are both primative data types

;;Exercise 5
;;rental-fee: num -> num
;;takes in a number and returns how much the rental costs
