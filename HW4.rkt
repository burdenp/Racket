...
(define (subst expr from to)
  ...
  (cases expr
    ...
    [(Not args) (If expr (Bool #f) (Bool #t))]
    [(And args1 args2) (If args1 args2 (Bool #f))]
    [(Or args1 args2) (If args1 (Bool #t) args2)]))
  ...
  (cases expr
    ...
    [(With bound-id named-expr bound-body)
     (eval (subst bound-body
                  ...
                  (value->algae (eval-number named-expr))))]
    [(Id name) (error 'eval "free identifier: ~s" name)]
    [(Bool b) b]
    [(If cond then else) (if (eval-boolean cond) (eval then) (eval else))]
    [(Not E) (eval (if E (Bool #f) (Bool #t)))]
    [(And args1 args2) 
     (eval (if (eval-boolean args1) args2 (Bool #f)))]
    [(Or args1 args2) (eval (if (eval-boolean args1) (Bool #t) args2))]))
