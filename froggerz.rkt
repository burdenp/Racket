...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname froggerz) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
;; Frogger game
(require 2htdp/image)
...
(define (endgame w)
  (cond[(empty? (world-vehicles w)) false]
       [(and (on-log? (world-player w) (world-vehicles w)) 
             (not (hit-car? (world-player w) (world-vehicles w))))  false]
       [(and (not (on-log? (world-player w) (world-vehicles w))) 
